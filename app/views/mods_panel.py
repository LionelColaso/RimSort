...
class ModsPanel(QWidget):
    ...
    def __init__(self, settings_controller: SettingsController) -> None:
        ...
        # Initialize ComboBox with type annotation
    ...
    def apply_mods_filter_type(self, list_type: str) -> None:
        ...
        if list_type == "Active":
            ...
            source_index: int = self.active_data_source_filter_type_index
        elif list_type == "Inactive":
            button = self.inactive_data_source_filter_type_button
            search = self.inactive_mods_search
            source_index = self.inactive_data_source_filter_type_index
        else:
        ...
        for uuid in mod_list.uuids:
            ...
            type_filtered = source_index == 0 or mod_types[source_index - 1] == mod_type

            item_data["type_filtered"] = not type_filtered
            item.setData(Qt.ItemDataRole.UserRole, item_data)
    ...
    def signal_search_and_filters(self, list_type: str, pattern: str) -> None:
        ...
        if list_type == "Active":
            ...
            mode_filter_state = self.active_mods_search_filter_state
        elif list_type == "Inactive":
            ...
            mode_filter_state = self.inactive_mods_search_filter_state
        else:
            raise NotImplementedError(f"Unknown list type: {list_type}")
        ...
        for uuid in uuids:
            ...
            if mode_filter_state:
                if list_type == "Active" and not metadata.get("enabled"):
                    item_filtered = True
                elif list_type == "Inactive" and metadata.get("enabled"):
                    item_filtered = True
