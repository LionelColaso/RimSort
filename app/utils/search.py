...
class SearchThread(QThread):
    ...
    def run(self):
        ...
        total_files = len(
            [file for root, _, files in os.walk(folder) for file in files]
        )
        ...
        for root, dirs, files in os.walk(folder):
            ...
            for file in files:
                ...
                if search_type == "File and Folder Names" and (
                    (not case_sensitive and search_text in file.lower())
                    or (case_sensitive and search_text in file)
                ):
                    count += 1
                ...
                if search_type == "File and Folder Names" and (
                    ...
                    try:
                        with open(
                            ...
                            if (
                                not case_sensitive
                                and search_text in file_contents.lower()
                            ) or (case_sensitive and search_text in file_contents):
                                count += 1
    ...
    def __init__(self):
        ...
        for button_label, extension in list_extensions_buttons:
            ...
            button.clicked.connect(
                lambda clicked=False, ext=extension: self.list_extensions(ext)
            )
    ...
    def start_search(self, search_text=None):
        if search_text is not None:
            ...
            self.search_text.setText(
                search_text
            )  # Set the search text from the argument
